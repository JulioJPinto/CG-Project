...
std::pair<std::pair<std::vector<Point>, std::vector<Point>>, std::vector<Point2D>>
    ...
    for (size_t i = 0; i < num_patches; ++i) {
        ...
        for (int u = 0; u < tessellation; ++u) {
            for (int v = 0; v < tessellation; ++v) {
                ...
                float length1 = std::sqrt(normal1.x * normal1.x + normal1.y * normal1.y + normal1.z * normal1.z);
                if (length1 != 0) {
                    normal1.x /= length1;
                    normal1.y /= length1;
                    normal1.z /= length1;
                ...
                float length2 = std::sqrt(normal2.x * normal2.x + normal2.y * normal2.y + normal2.z * normal2.z);
                if (length2 != 0) {
                    normal2.x /= length2;
                    normal2.y /= length2;
                    normal2.z /= length2;
                ...
                float length3 = std::sqrt(normal3.x * normal3.x + normal3.y * normal3.y + normal3.z * normal3.z);
                if (length3 != 0) {
                    normal3.x /= length3;
                    normal3.y /= length3;
                    normal3.z /= length3;
                ...
                float length4 = std::sqrt(normal4.x * normal4.x + normal4.y * normal4.y + normal4.z * normal4.z);
                if (length4 != 0) {
                    normal4.x /= length4;
                    normal4.y /= length4;
                    normal4.z /= length4;
