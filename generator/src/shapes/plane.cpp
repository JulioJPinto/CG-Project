...
std::pair<std::pair<std::vector<Point>, std::vector<Point>>, std::vector<Point2D>> planeAllPoints(float length, int divisions) {
...
bool generatePlane(float length, int divisions, const char* filepath) {
  std::pair<std::pair<std::vector<Point>, std::vector<Point>>, std::vector<Point2D>> plane = planeAllPoints(length, divisions);
